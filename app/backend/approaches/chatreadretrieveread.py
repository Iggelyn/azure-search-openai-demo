...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """Assistant helps the company employees with their questions. Be brief in your answers.
    ...
    async def run_until_final_call(
        ...
        match functioncall:
                case FunctionCall.FILTER_BY_MODIFIED_ON:
                   content = "Nenne Keine Datei Doppelt. Hier die Liste der Dateinamen die den kriterien entsprechen:"
